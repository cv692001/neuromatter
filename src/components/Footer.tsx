    ...
    <footer className="bg-section-dark overflow-hidden">
      ...
      <div className="px-6 md:px-12 lg:px-20 py-10 md:py-12">
        <div className="container-custom">
          ...
          {/* Quick Links */}
          <motion.div
            className="py-6 border-t border-section-dark-foreground/10"
            initial={{ opacity: 0 }}
          ...
          >
            ...
            <div className="mt-6 pt-6 border-t border-section-dark-foreground/10 grid grid-cols-2 lg:grid-cols-4 gap-x-4 gap-y-6">
